...
test_data_descr = '''like 6, but with noise and better spaced intervals'''
...
for rawn in rawnames:
    anndict_per_intcat_per_rawn[rawn] = {'artif':{
        ...
        'beh_state':[]}
ann1 = mne.Annotations([2.6,6,12,17],[2,4,3.6,3],
                       ['notrem_L','trem_L','hold_L','notrem_L'])
ann2 = mne.Annotations([2.6,6,12,17],[2,4,3.6,3],
                       ['notrem_L','trem_L','move_L','notrem_L'])
